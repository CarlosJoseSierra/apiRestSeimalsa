...
var client = new _clientEc.EC2Client({
  region: _config.AWS_REGION || "us-east-1",
  credentials: {
    accessKeyId: _config.AWS_ACCESS_KEY_ID,
    // <--- Aquí ya NO va tu llave real
    secretAccessKey: _config.AWS_SECRET_ACCESS_KEY // <--- Aquí ya NO va tu llave secreta real
  }
});
...
var updateIpAccess = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var userName, ruleId, userIp, cleanIp, command;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          userName = req.params.name; // Usando params como definimos en la ruta
          ruleId = SECURITY_RULES[userName === null || userName === void 0 ? void 0 : userName.toUpperCase()];
          if (ruleId) {
            _context.next = 5;
            break;
          }
          return _context.abrupt("return", res.status(400).json({
            message: "Usuario no configurado en AWS"
          }));
        case 5:
...
exports.updateIpAccess = updateIpAccess;