...
var createEnsamble = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 72:
          ...
          _context3.next = 78;
          return new _database.sql.Request(_transaction).input('mo_det_id', _database.sql.Decimal(18, 0), mo_det_id).input('costoHora', _database.sql.Decimal(18, 4), sueldo).input('EMP_id', _database.sql.Decimal(18, 0), emp.EMP_id).query("INSERT INTO EMPLEADO_MANOOBRA (EMP_MO_PROD_DETMO_id,EMP_MO_costoHora, EMP_MO_EMP_id,EMP_MO_estado,\n                  fecha_ingreso,fecha_actualizacion) \n                        VALUES (@mo_det_id, @costoHora,@EMP_id,1,GETDATE(),GETDATE())");
        case 78:
          _context3.next = 72;
          break;
        case 80:
        ...
        case 101:
          ...
          _m = _step3.value;
          valor = void 0;
          if (typeof _m.CI_valor === 'string') {
            valor = parseFloat(_m.CI_valor.replace(',', '.'));
          } else {
            valor = _m.CI_valor;
          }
          _context3.next = 107;
        ...
        case 111:
          _context3.prev = 111;
          _context3.t3 = _context3["catch"](99);
    ...
    }, _callee3, null, [[0, 122], [36, 50, 53, 56], [57, 92, 95, 98], [70, 82, 85, 88], [99, 111, 114, 117]]);
  }));
...
var updateEnsamble = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          id = req.params.id;
          _req$body2 = req.body, PROD_codigo = _req$body2.PROD_codigo, PROD_nombre = _req$body2.PROD_nombre, PROD_medida = _req$body2.PROD_medida, PROD_costoUnitario = _req$body2.PROD_costoUnitario, PROD_precioMinimo = _req$body2.PROD_precioMinimo, PROD_pvp = _req$body2.PROD_pvp, PROD_item = _req$body2.PROD_item, PROD_costoUnitarioH = _req$body2.PROD_costoUnitarioH, PROD_precioMinimoH = _req$body2.PROD_precioMinimoH, PROD_pvpH = _req$body2.PROD_pvpH, PROD_TotalMP = _req$body2.PROD_TotalMP, PROD_TotalMO = _req$body2.PROD_TotalMO, PROD_TotalCIF = _req$body2.PROD_TotalCIF, PROD_TotalFInal = _req$body2.PROD_TotalFInal, PROD_utilidad = _req$body2.PROD_utilidad, PROD_itemsXhora = _req$body2.PROD_itemsXhora, PROD_mp = _req$body2.PROD_mp, PROD_mo = _req$body2.PROD_mo, PROD_cif = _req$body2.PROD_cif, PROD_listaMO = _req$body2.PROD_listaMO, PROD_image = _req$body2.PROD_image;
          imageruta = '';
          if (typeof PROD_costoUnitario === 'string') {
            vc_PROD_costoUnitario = parseFloat(PROD_costoUnitario.replace(',', '.'));
          } else {
        ...
        case 58:
          _iterator6 = _createForOfIteratorHelper(PROD_listaMO);
          _context4.prev = 59;
          _iterator6.s();
        case 61:
          ...
          console.log(empAnt);
          _context4.next = 66;
          return new _database.sql.Request(transaction).input('idE', _database.sql.Decimal, empAnt.PROD_DETMO_id).query("UPDATE EMPLEADO_MANOOBRA SET EMP_MO_estado = 0, fecha_actualizacion = GETDATE() WHERE EMP_MO_PROD_DETMO_id =@idE");
        case 66:
          _context4.next = 61;
          break;
        case 68:
        ...
        case 76:
          _iterator7 = _createForOfIteratorHelper(manoObra);
          _context4.prev = 77;
          _iterator7.s();
        case 79:
          ...
          _cantidad2 = void 0;
          if (typeof mo.cantidad === 'string') {
            _cantidad2 = parseFloat(mo.cantidad.replace(',', '.'));
          } else {
            _cantidad2 = mo.cantidad;
          }
          total = mo.cantidad / vc_PROD_itemsXhora;
          _context4.next = 87;
        ...
        case 87:
          ...
          mo_det_id = resultMO.recordset[0].mo_det_id;
          _iterator9 = _createForOfIteratorHelper(mo.empleadosSeleccionados);
          _context4.prev = 90;
          _iterator9.s();
        case 92:
        ...
        case 102:
          ...
          _iterator9.e(_context4.t2);
        case 105:
          _context4.prev = 105;
          _iterator9.f();
          return _context4.finish(105);
        case 108:
          _context4.next = 79;
          break;
        case 110:
        ...
        case 112:
          _context4.prev = 112;
          _context4.t3 = _context4["catch"](77);
          _iterator7.e(_context4.t3);
        case 115:
          _context4.prev = 115;
          _iterator7.f();
          return _context4.finish(115);
        case 118:
          _iterator8 = _createForOfIteratorHelper(cif);
          _context4.prev = 119;
          _iterator8.s();
        case 121:
          ...
          _m2 = _step8.value;
          valor = void 0;
          if (typeof _m2.CI_valor === 'string') {
            valor = parseFloat(_m2.CI_valor.replace(',', '.'));
          } else {
            valor = _m2.CI_valor;
          }
          _context4.next = 127;
        ...
        case 131:
          _context4.prev = 131;
          _context4.t4 = _context4["catch"](119);
        ...
        case 150:
          _context4.prev = 150;
          _context4.t6 = _context4["catch"](145);
    ...
    }, _callee4, null, [[0, 142], [39, 52, 55, 58], [59, 70, 73, 76], [77, 112, 115, 118], [90, 102, 105, 108], [119, 131, 134, 137], [145, 150]]);
  }));
