...
exports.updateMP = exports.getMPById = exports.getAllMP = exports.createMP = void 0;
...
var getAllMP = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          pool = _context.sent;
          _context.next = 6;
          return pool.request().query(_database.querys.getAllMP);
        case 6:
  ...
  return function getAllMP(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.getAllMP = getAllMP;
var getMPById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          pool = _context2.sent;
          _context2.next = 7;
          return pool.request().input("id", id).query(_database.querys.getMPById);
        case 7:
  ...
  return function getMPById(_x3, _x4) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          pool = _context3.sent;
          _context3.next = 7;
          return pool.request().input('MP_descripcion', _database.sql.VarChar, _materia.Descripcion).input('MP_medida', _database.sql.VarChar, _materia.Medida).input('MP_costo', _database.sql.Decimal(18, 4), _materia.Costo).input('MP_categoria', _database.sql.VarChar, _materia.Categoria).query(_database.querys.createMP);
        case 7:
