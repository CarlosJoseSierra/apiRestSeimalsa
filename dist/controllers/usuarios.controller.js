    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          pool = _context.sent;
          _context.next = 6;
          return pool.request().query(_querys.querys.getAllUsuarios);
        case 6:
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 9:
          _context3.next = 11;
          return pool.request().input("USU_usuario", _mssql["default"].VarChar, USU_usuario).query(_querys.querys.getUserPass);
        case 11:
...
var createFirmaUser = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _result$recordset, _registro$status, _registro$msg, archivos, _iterator, _step, archivo, resultadoCloudinary, pool, result, registro, _ref5, _error$originalError$, _error$originalError, _error$originalError$2;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 23:
          pool = _context4.sent;
          _context4.next = 26;
          return pool.request().input('USU_firma', _mssql["default"].VarChar(1000), imagenes[0]).execute('dbo.sp_Usuario_InsertarFirma');
        case 26:
        ...
        case 31:
          ...
          console.error('Error insertando AREA_SERVICIO:', _context4.t1);
          return _context4.abrupt("return", res.status(500).json({
            status: 'error',
            msg: (_ref5 = (_error$originalError$ = _context4.t1 === null || _context4.t1 === void 0 ? void 0 : (_error$originalError = _context4.t1.originalError) === null || _error$originalError === void 0 ? void 0 : (_error$originalError$2 = _error$originalError.info) === null || _error$originalError$2 === void 0 ? void 0 : _error$originalError$2.message) !== null && _error$originalError$ !== void 0 ? _error$originalError$ : _context4.t1 === null || _context4.t1 === void 0 ? void 0 : _context4.t1.message) !== null && _ref5 !== void 0 ? _ref5 : 'No se pudo registrar la cotización.',
            token: 0
          }));
        case 35:
        case "end":
