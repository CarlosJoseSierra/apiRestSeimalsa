...
router.get("/areaservicio/tec/:idTecnico", _areaservicio.getReparacionesXtecnico);
...
router.post("/areaservicio/new", storage.array('image', 7), _areaservicio.createNewAreaServicio);
...
router.get('/areaservicio/dashboard/:usuarioId', _areaservicio.obtenerDashboardTecnico);
var _default = router;
